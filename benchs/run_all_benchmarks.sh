...
# Runs the full SuCo benchmark suite across SIFT1M, GIST1M, and Deep1M.
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --sift-only)  RUN_GIST=0; RUN_DEEP=0; shift ;;
        --gist-only)  RUN_SIFT=0; RUN_DEEP=0; shift ;;
        --deep-only)  RUN_SIFT=0; RUN_GIST=0; shift ;;
        -h|--help)
