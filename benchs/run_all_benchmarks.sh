...
if [[ $RUN_SIFT -eq 1 ]]; then
    ...
    run_bench "${SIFT_BASE[@]}" --sweep
    run_bench "${SIFT_BASE[@]}" --flat-baseline
    run_bench "${SIFT_BASE[@]}" --hnsw-sweep
    run_bench "${SIFT_BASE[@]}" --ivfflat-sweep
    run_bench "${SIFT_BASE[@]}" --ivfpq-sweep
    run_bench "${SIFT_BASE[@]}" --opqpq-sweep
fi
...
if [[ $RUN_GIST -eq 1 ]]; then
    ...
    run_bench "${GIST_BASE[@]}" --sweep
    run_bench "${GIST_BASE[@]}" --flat-baseline
    run_bench "${GIST_BASE[@]}" --hnsw-sweep
    run_bench "${GIST_BASE[@]}" --ivfflat-sweep
    run_bench "${GIST_BASE[@]}" --ivfpq-sweep
    run_bench "${GIST_BASE[@]}" --opqpq-sweep
fi
...
if [[ $RUN_DEEP -eq 1 ]]; then
    ...
    run_bench "${DEEP_BASE[@]}" --sweep
    run_bench "${DEEP_BASE[@]}" --flat-baseline
    run_bench "${DEEP_BASE[@]}" --hnsw-sweep
    run_bench "${DEEP_BASE[@]}" --ivfflat-sweep
    run_bench "${DEEP_BASE[@]}" --ivfpq-sweep
    run_bench "${DEEP_BASE[@]}" --opqpq-sweep
fi
...
if [[ $RUN_SIFT10M -eq 1 ]]; then
    ...
    run_bench "${SIFT10M_BASE[@]}" --sweep
    run_bench "${SIFT10M_BASE[@]}" --flat-baseline
    run_bench "${SIFT10M_BASE[@]}" --hnsw-sweep
    run_bench "${SIFT10M_BASE[@]}" --ivfflat-sweep
    run_bench "${SIFT10M_BASE[@]}" --ivfpq-sweep
    run_bench "${SIFT10M_BASE[@]}" --opqpq-sweep
fi
...
if [[ $RUN_SPACEV10M -eq 1 ]]; then
    ...
    run_bench "${SPACEV10M_BASE[@]}" --sweep
    run_bench "${SPACEV10M_BASE[@]}" --flat-baseline
    run_bench "${SPACEV10M_BASE[@]}" --hnsw-sweep
    run_bench "${SPACEV10M_BASE[@]}" --ivfflat-sweep
    run_bench "${SPACEV10M_BASE[@]}" --ivfpq-sweep
    run_bench "${SPACEV10M_BASE[@]}" --opqpq-sweep
fi
