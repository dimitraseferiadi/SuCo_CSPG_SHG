...
LSH_NBITS_SWEEP = [96, 192, 384, 768, 1536]
...
def parse_args():
    ...
    p.add_argument(
        "--lsh-nbits", type=int, default=192,
...
def main():
    ...
    # ------------------------------------------------------------------
    if args.lsh:
        print_header("IndexLSH benchmark(Deep1B subset, d=96)")   # ← edit label per-file
    ...
    if args.lsh_sweep:
        run_lsh_nbits_sweep(
            ...
            k=args.k,
            index_path=args.index_path,
            dataset_tag="Deep1B subset, d=96",
        )
