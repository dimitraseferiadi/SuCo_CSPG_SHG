...
class IndexFlatIPPanorama(IndexFlatPanorama):
    ...
    def __init__(self, d, n_levels, batch_size=512):
        ...
        :param batch_size: batch size for Panorama storage
        """
        _swigfaiss.IndexFlatIPPanorama_swiginit(self, _swigfaiss.new_IndexFlatIPPanorama(d, n_levels, batch_size))
...
class SuCoHashPair(object):
    ...
    def __call__(self, p):
        return _swigfaiss.SuCoHashPair___call__(self, p)

    def __init__(self):
        _swigfaiss.SuCoHashPair_swiginit(self, _swigfaiss.new_SuCoHashPair())
    __swig_destroy__ = _swigfaiss.delete_SuCoHashPair

# Register SuCoHashPair in _swigfaiss:
_swigfaiss.SuCoHashPair_swigregister(SuCoHashPair)
class IndexSuCo(Index):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    nsubspaces = property(_swigfaiss.IndexSuCo_nsubspaces_get, _swigfaiss.IndexSuCo_nsubspaces_set, doc=r"""Number of subspaces  Ns   (d must be divisible by nsubspaces)""")
    ncentroids_half = property(_swigfaiss.IndexSuCo_ncentroids_half_get, _swigfaiss.IndexSuCo_ncentroids_half_set, doc=r"""Number of K-means centroids per *half*-subspace  sqrt(K)""")
    collision_ratio = property(_swigfaiss.IndexSuCo_collision_ratio_get, _swigfaiss.IndexSuCo_collision_ratio_set, doc=r"""Fraction of the dataset to retrieve per subspace as collisions  (alpha)""")
    candidate_ratio = property(_swigfaiss.IndexSuCo_candidate_ratio_get, _swigfaiss.IndexSuCo_candidate_ratio_set, doc=r"""Fraction of the dataset to use as the re-rank candidate pool  (beta)""")
    niter = property(_swigfaiss.IndexSuCo_niter_get, _swigfaiss.IndexSuCo_niter_set, doc=r"""Number of K-means training iterations""")
    subspace_dim = property(_swigfaiss.IndexSuCo_subspace_dim_get, _swigfaiss.IndexSuCo_subspace_dim_set, doc=r"""d / nsubspaces  (must be even)""")
    half_dim = property(_swigfaiss.IndexSuCo_half_dim_get, _swigfaiss.IndexSuCo_half_dim_set, doc=r"""subspace_dim / 2""")
    centroids = property(_swigfaiss.IndexSuCo_centroids_get, _swigfaiss.IndexSuCo_centroids_set, doc=r"""
    ...
    """)
    imi = property(_swigfaiss.IndexSuCo_imi_get, _swigfaiss.IndexSuCo_imi_set, doc=r"""
    ...
    """)
    xb = property(_swigfaiss.IndexSuCo_xb_get, _swigfaiss.IndexSuCo_xb_set, doc=r"""
    ...
    def __init__(self, d, nsubspaces=8, ncentroids_half=50, collision_ratio=0.05, candidate_ratio=0.005, niter=10):
        r"""
        :type d: int
        :param d:                 Vector dimensionality.
        :type nsubspaces: int, optional
        :param nsubspaces:        Number of subspaces (default 8).
        :type ncentroids_half: int, optional
        :param ncentroids_half:   K-means centroids per half-subspace (default 50).
        :type collision_ratio: float, optional
        :param collision_ratio:   alpha (default 0.05).
        :type candidate_ratio: float, optional
        :param candidate_ratio:   beta  (default 0.005).
        :type niter: int, optional
        :param niter:             K-means iterations (default 10).
        """
        _swigfaiss.IndexSuCo_swiginit(self, _swigfaiss.new_IndexSuCo(d, nsubspaces, ncentroids_half, collision_ratio, candidate_ratio, niter))
    __swig_destroy__ = _swigfaiss.delete_IndexSuCo
    ...
    def train(self, n, x):
        ...
        """
        return _swigfaiss.IndexSuCo_train(self, n, x)
    ...
    def add(self, n, x):
        ...
        """
        return _swigfaiss.IndexSuCo_add(self, n, x)
    ...
    def search(self, n, x, k, distances, labels, params=None):
        ...
        """
        return _swigfaiss.IndexSuCo_search(self, n, x, k, distances, labels, params)

    def reset(self):
        r"""Reset the index to an untrained, empty state."""
        return _swigfaiss.IndexSuCo_reset(self)

    def write_index(self, fname):
        r"""Write the index (centroids + IMI) to a binary file."""
        return _swigfaiss.IndexSuCo_write_index(self, fname)

    def read_index(self, fname):
        r"""Read the index from a binary file produced by write_index()."""
        return _swigfaiss.IndexSuCo_read_index(self, fname)

# Register IndexSuCo in _swigfaiss:
_swigfaiss.IndexSuCo_swigregister(IndexSuCo)
